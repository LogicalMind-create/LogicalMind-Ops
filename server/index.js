...
app.listen(PORT, async () => {
  ...
  // Start notification scheduler for APPX
  if (process.env.TEACHX_USERNAME) {
    require('./jobs/notificationScheduler').start();
  } else {
    console.warn('[⚠️  Warning] TEACHX_USERNAME not set — notification scheduler disabled');
  }
});
